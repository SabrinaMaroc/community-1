...
l'oculaire digital Bresser 0,3M fournit avec le microscope Biolux Ng (ou Al) est du type WebCam, le chip vidéo USB est un <u>CIF Single Chip</u>

- trouver le pilote de cet oculaire revient donc à trouver le pilote (ou  drivers) de n'importe quelle WebCam équipée de cette puce électronique,  quelque soit la marque ou le modèle

drivers est disponible sur le site d'Olitec, ou sur [le site de référence ](http://www.touslesdrivers.com/index.php ... code=13612) 

- le drivers est donc téléchargé

- oculaire digital NON CONNECTE, le programme d'installation du drivers est exécuté (setup-webcam-usb-v1.exe)

-  puis l'oculaire digital est branché sur une prise USB 2.0 et le système  propose de rechercher un drivers - choisir installation hors Web -  suivant - recherche automatique.

- le drivers s'installe, le système déclare : "Matériel prêt à fonctionner"

Microscopie Open source :

+ orienté Linux : [](http://gxsm.sourceforge.net/)http://gxsm.sourceforge.net/

+ multi-plateforme (Nicolas teste la version Windows) [](https://micro-manager.org/wiki/Micro-Manager)https://micro-manager.org/wiki/Micro-Manager

++ apparemment plein de vidéos explicatives en ligne : [](https://www.youtube.com/watch?v=y-R9WmhzPdI)https://www.youtube.com/watch?v=y-R9WmhzPdI
...
<a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img alt="Licence Creative Commons" style="border-width:0" src="https://i.creativecommons.org/l/by-sa/4.0/88x31.png" /></a><br /><span xmlns:dct="http://purl.org/dc/terms/" property="dct:title">Biomimicry Master Class 2016</span> de <a xmlns:cc="http://creativecommons.org/ns#" href="https://lebiome.github.io/#LeBiome/community/blob/master/masterclass_2016.md" property="cc:attributionName" rel="cc:attributionURL">Les participants et le Biome</a> est mis à disposition selon les termes de la <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">licence Creative Commons Attribution -  Partage dans les Mêmes Conditions 4.0 International</a>.<br />Fondé(e) sur une œuvre à <a xmlns:dct="http://purl.org/dc/terms/" href="https://hackpad.com/Biomimicry-master-class-2016-CE4UDzw2T1F" rel="dct:source">https://hackpad.com/Biomimicry-master-class-2016-CE4UDzw2T1F</a>.
